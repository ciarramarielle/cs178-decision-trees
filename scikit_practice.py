...
y = np.genfromtxt('data/kaggle.Y.train.txt', delimiter=None)
...
def explore_max_depth(range_1_to_n):
    mse_list = []
    for i in range(1, range_1_to_n):
    ...
    l = [i for i in range(1,range_1_to_n)]
